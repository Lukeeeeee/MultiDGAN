...
def decrim1(x, is_training, reuse, batch_size=64):
	with tf.variable_scope('decriminator1') as scope:
...
def decrim2(x, is_training, reuse, batch_size=64):
	with tf.variable_scope('decriminator2') as scope:
		conv0 = lay.conv_2d_layer(x, 'd_conv0', [5,5,3,64], strides=[1,2,2,1])
		conv0 = lay.batch_norm_official(conv0, is_training=is_training, reuse=reuse,name = 'd_bn0')
		conv0 = lay.leaky_relu(conv0)
